Attached in this repository are the only essential and modified code files from a latest vite+react app and a word document that contains screenshots of the implementation of the experiment.
